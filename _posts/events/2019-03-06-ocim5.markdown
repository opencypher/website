...
* Thursday: [link](https://neo4j.zoom.us/j/763749182)
...
* Multiple graphs and composable queries, exemplified by a live demonstration of [CAPS](https://github.com/opencypher/cypher-for-apache-spark) [Cypher for Apache Spark] (_Martin Junghanns_ & _Max Kießling_, [_Neo4j_](https://neo4j.com/))
* Property graph schema definition and table-to-graph mapping in CAPS (_Max Kießling_ & _Martin Junghanns_, [_Neo4j_](https://neo4j.com/))
...
* Overview of current CIPs (Cypher Improvement Proposals) (_Satia Herfert_, [_Neo4j_](https://neo4j.com/)) 
