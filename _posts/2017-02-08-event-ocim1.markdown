...
The detailed programme of events may be found [here](#programme).
...
A PDF version of the programme may be downloaded [here](https://s3.amazonaws.com/artifacts.opencypher.org/website/oCIMProgram.pdf).
...
<table>
    ...
    <tr>
        ...
        <td colspan="1" rowspan="1"><p>Graph Pattern Matching in SAP HANA</p></td>
        <td colspan="1" rowspan="1"><p>Marcus Paradies (SAP)</p></td>
        <td colspan="1" rowspan="1"><p>15 mins</p></td>
    </tr>
    <tr>
        <td colspan="1" rowspan="1"><p>10:15</p></td>
        <td colspan="1" rowspan="1"><p>Cypher in JetBrains IDE</p></td>
    ...
    <tr>
        ...
        <td colspan="1" rowspan="1"><p>Language Integration: SQL, GraphQL, and Tinkerpop</p></td>
    ...
    <tr>
        <td colspan="1" rowspan="1" class="item"><p>CRPQs</p></td>
