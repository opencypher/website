...
<table>
    ...
    <tr>
        ...
        <td colspan="1" rowspan="1"><p>Introduction & Status Report (<a href="" target="_blank">slides</a>)</p></td>
    ...
    <tr>
        ...
        <td colspan="1" rowspan="1"><p>Updated CIP/oCIG Process (<a href="" target="_blank">slides</a>)</p></td>
    ...
    <tr>
        <td colspan="2" rowspan="1" class="item">
            ...
            <ul>
                <li><a href="https://github.com/opencypher/openCypher/pull/100" target="_blank">Nested Subqueries</a> (<a href="" target="_blank">slides</a>)</li>
                <li><a href="https://github.com/opencypher/openCypher/pull/227" target="_blank">Query Combinators</a> (<a href="" target="_blank">slides</a>)</li>
                <li><a href="https://github.com/opencypher/openCypher/pull/212" target="_blank">MANDATORY MATCH</a> (<a href="" target="_blank">slides</a>)</li>
    ...
    <tr>
        ...
        <td colspan="1" rowspan="1"><p><a href="https://github.com/opencypher/openCypher/pull/187" target="_blank">Regular Path Queries (RPQs)</a> (<a href="" target="_blank">slides</a>)</p></td>
    ...
    <tr>
        ...
        <td colspan="1" rowspan="1"><p>Implementation in Prolog (<a href="" target="_blank">slides</a>)</p></td>
    ...
    <tr>
        ...
        <td colspan="1" rowspan="1"><p>The ingraph project and incremental evaluation of Cypher queries (<a href="" target="_blank">slides</a>)</p></td>
    ...
    <tr>
        ...
        <td colspan="1" rowspan="1"><p>Mode of collaboration (<a href="" target="_blank">slides</a>)</p></td>
        <td colspan="1" rowspan="1"><p>Alastair Green (Neo Technology)</p></td>
        <td colspan="1" rowspan="1"><p>5 mins</p></td>
    </tr>
    <tr>
        <td colspan="1" rowspan="1"><p>14:20</p></td>
        <td colspan="1" rowspan="1"><p>Web-based Cypher editor in relationship to openCypher (<a href="" target="_blank">slides</a>)</p></td>
        <td colspan="1" rowspan="1"><p>Dmitry Vrublevsky (Neueda)</p></td>
        <td colspan="1" rowspan="1"><p>15 mins</p></td>
    </tr>
    <tr>
        <td colspan="1" rowspan="1"><p>14:35</p></td>
        <td colspan="1" rowspan="1"><p>openCypher TCK (<a href="" target="_blank">slides</a>)</p></td>
    ...
    <tr>
        <td colspan="2" rowspan="1" class="item"><p>User requirements (Frank Smit's <a href="" target="_blank">slides</a>)</p></td>
    </tr>
    <tr>
        <td colspan="1" rowspan="1" class="item"><p>Identification and addressing (<a href="" target="_blank">slides</a>)</p></td>
        <td colspan="1" rowspan="1"><p>Alastair Green (Neo Technology)</p></td>
    </tr>
    <tr>
        <td colspan="1" rowspan="1" class="item"><p>Syntax and semantics (<a href="" target="_blank">slides</a>)</p></td>
        <td colspan="1" rowspan="1"><p>Stefan Plantikow (Neo Technology)</p></td>
    </tr>
    </tr>
    <tr class="break">
    ...
    <tr>
        <td colspan="2" rowspan="1" class="item"><p>Presentation by Scott Tiger (<a href="" target="_blank">slides</a>)</p></td>
    </tr>
    <tr>
        <td colspan="2" rowspan="1" class="item"><p>Presentation by J&oacute;zsef Marton (<a href="" target="_blank">slides</a>)</p></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="1" rowspan="1"><p>Sorting lists (<a href="" target="_blank">slides</a>)</p></td>
